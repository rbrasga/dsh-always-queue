...
export const zh = {
  ...
  /** Banner naming the session(s) holding the gate; {n} held count, {who} titles. */
  'waiting.heldBy': '{n} 条消息排队中 — 等待 {who} 结束或暂停后自动发送',
  ...
  /** Composer notice naming the session(s) holding the gate. */
  'queued.by': '已排队：{who} 结束或暂停后自动发送',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'waiting.heldBy': '{n} message(s) queued — waiting for {who} to finish or pause',
  ...
  'queued.by': 'Queued: waiting for {who} to finish or pause — will send automatically',
